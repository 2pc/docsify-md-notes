...
test('render Markdown from TSDoc', () => {
    ...
    output.appendNodes([
        ...
        new tsdoc_1.DocParagraph({ configuration }, [
            ...
            new DocEmphasisSpan_1.DocEmphasisSpan({ configuration, bold: true }, [new tsdoc_1.DocPlainText({ configuration, text: ' three ' })]),
            new tsdoc_1.DocPlainText({ configuration, text: '' }),
    ...
    output.appendNodes([
        ...
        new tsdoc_1.DocParagraph({ configuration }, [
            new DocEmphasisSpan_1.DocEmphasisSpan({ configuration, bold: true }, [new tsdoc_1.DocPlainText({ configuration, text: '*one*two*' })]),
            new DocEmphasisSpan_1.DocEmphasisSpan({ configuration, bold: true }, [new tsdoc_1.DocPlainText({ configuration, text: 'three*four' })])
        ])
    ]);
    output.appendNodes([
        ...
        new tsdoc_1.DocParagraph({ configuration }, [new tsdoc_1.DocPlainText({ configuration, text: 'HTML chars: <script>alert("[You] are #1!");</script>' })]),
        new tsdoc_1.DocParagraph({ configuration }, [new tsdoc_1.DocPlainText({ configuration, text: 'HTML escape: &quot;' })]),
        new tsdoc_1.DocParagraph({ configuration }, [new tsdoc_1.DocPlainText({ configuration, text: '3 or more hyphens: - -- --- ---- ----- ------' })])
    ]);
    output.appendNodes([
